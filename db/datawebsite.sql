...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 19, 2024 lúc 12:42 PM
...
INSERT INTO `discount` (`id`, `name`, `discount`, `idCat`, `dateStart`, `dateEnd`, `status`) VALUES
(5, 'Khuyến mại sinh nhật tháng 8', '10', 42, '2024-07-18', '2024-07-24', 1);
...
INSERT INTO `orders` (`id`, `customer_id`, `create_at`, `status`, `total_cost`, `idVoucher`) VALUES
(46, 19, '2024-07-19', 0, '31390000', 0),
(47, 19, '2024-07-19', 0, '23184000', 2);
...
INSERT INTO `providers` (`id`, `name`, `phone`, `email`, `local`) VALUES
(1, 'Nikeee', '0123456789', 'nike@gmail.com', 'Ha Noi');
...
CREATE TABLE `vouchers` (
  `id` int(50) NOT NULL,
  `ma` varchar(500) NOT NULL,
  `soluong` varchar(200) NOT NULL,
  `dk_hoadon` varchar(200) NOT NULL,
  `timeStart` varchar(30) NOT NULL,
  `timeEnd` varchar(30) NOT NULL,
  `dk_soluong` varchar(100) NOT NULL,
...
INSERT INTO `vouchers` (`id`, `ma`, `soluong`, `dk_hoadon`, `timeStart`, `timeEnd`, `dk_soluong`, `discount`, `description`, `status`) VALUES
(2, 'ABCRTHJ', '198', '200000', '2024-07-18', '2024-07-25', '2', '20', '', 1),
(5, 'QWERTYUIOP', '198', '200000', '2024-07-18', '2024-07-24', '', '15', '', 1),
(6, 'ZXCVBVCXZ', '198', '500000', '2024-07-18', '2024-07-31', '', '50', '', 1),
(7, 'ABCDEFGH', '197', '200000', '2024-07-18', '2024-07-23', '2', '20', '', 1),
(8, 'qqqqq', '123', '200000', '2024-07-20', '2024-07-24', '', '20', '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `voucheruser`
--

CREATE TABLE `voucheruser` (
  `id` int(50) NOT NULL,
  `idVoucher` int(50) NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `voucheruser`
--

INSERT INTO `voucheruser` (`id`, `idVoucher`, `idUser`, `status`, `soluong`) VALUES
(9, 2, 19, 0, 0),
(10, 5, 19, 0, 1),
(11, 7, 19, 0, 1);
...
--
-- Chỉ mục cho bảng `voucheruser`
--
ALTER TABLE `voucheruser`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT cho bảng `voucheruser`
--
ALTER TABLE `voucheruser`
