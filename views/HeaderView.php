<header id="header">
  ...
  <div class="mid-header">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo "> <a href="index.php"> <img src="assets/frontend/100/047/633/themes/517833/assets/logo.png" alt="User" title="User" class="img-responsive" style="height: 120px;width: 200px;object-fit: contain;"> </a> </div>
        <div class="col-xs-12 col-sm-12 col-md-6 header-search">
          <!--<form method="post" id="frm" action="">-->
          <div style="margin-top:25px; position: relative;">
            <form method="GET">

              <input style="border:1px solid black" type="text" value="<?php echo isset($_GET['search']) ? $_GET['search'] : '' ?>" name="search" placeholder="Nhập từ khóa tìm kiếm..." id="key" class="input-control">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 mini-cart">
          <div class="wrapper-mini-cart"> <span style="background-color:black" class="icon"><i class="fa fa-shopping-cart"></i></span> <a style="text-decoration:none;color:black" href="index.php?controller=cart"> <span class="mini-cart-count"> <?php echo $numberProduct; ?> </span> sản phẩm <i class="fa fa-caret-down"></i></a>
    ...
    <!-- end middle header -->
    <!-- bottom header -->
    <div class="bottom-header" style="background:white">
      <div class="container">
        <div class="clearfix">
          <ul class="main-nav hidden-xs hidden-sm list-unstyled ">

            <li><a style="color:black;font-weight:bold;font-size:15px;text-decoration:none" class="bottom-header-menu" href="index.php">Trang chủ</a></li>

            <!-- menu1 -->
            <li class="has-submenu"> <a style="color:black;font-weight:bold;font-size:15px;text-decoration:none" class="bottom-header-menu" href="#"> <span>Sản phẩm</span><i class="fa fa-caret-down" style="margin-left: 5px;"></i> </a>
              <ul class="list-unstyled level1">
                ...
                <?php foreach ($categories as $rows) : ?>
                  <li><a style="text-decoration:none;color:black" href="index.php?controller=products&action=categories&category_id=<?php echo $rows->id; ?>"><?php echo $rows->name; ?></a></li>
                  <?php
                  //load cap 2
                  $categoriesSub = $this->modelGetCategoriesSub($rows->id);
                  ?>
                  <?php foreach ($categoriesSub as $rowsSub) : ?>
                    <li style="padding-left:20px;"><a style="text-decoration:none;color:black" href="index.php?controller=products&action=categories&category_id=<?php echo $rowsSub->id; ?>"><?php echo $rowsSub->name; ?></a></li>
                  <?php endforeach; ?>
                <?php endforeach; ?>
              </ul>
            </li>
            ...
            <li><a style="color:black;font-weight:bold;font-size:15px;text-decoration:none" class="bottom-header-menu" href="index.php?controller=cart">Giỏ hàng</a></li>
            <li><a style="color:black;font-weight:bold;font-size:15px;text-decoration:none" class="bottom-header-menu" href="index.php?controller=news">Tin tức</a></li>
            <li><a style="color:black;font-weight:bold;font-size:15px;text-decoration:none" class="bottom-header-menu" href="index.php?controller=contact">Liên hệ</a></li>
          </ul>
