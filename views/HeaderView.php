...
<div class="container">
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 mini-cart">
      <div class="wrapper-mini-cart"> <span style="background-color:black" class="icon"><i class="fa fa-shopping-cart"></i></span> <a href="index.php?controller=cart"> <span class="mini-cart-count"> <?php echo $numberProduct; ?> </span> sản phẩm <i class="fa fa-caret-down"></i></a>
  ...
  <div class="container">
    <div class="clearfix">
      <ul class="main-nav hidden-xs hidden-sm list-unstyled ">
        ...
        <li ><a style="color:black;font-weight:bold;font-size:15px" class="bottom-header-menu" href="index.php">Trang chủ</a></li>

        <!-- menu1 -->
        <li class="has-submenu"> <a style="color:black;font-weight:bold;font-size:15px" class="bottom-header-menu" href="#"> <span>Sản phẩm</span><i class="fa fa-caret-down" style="margin-left: 5px;"></i> </a>
        ...
        <li><a style="color:black;font-weight:bold;font-size:15px" class="bottom-header-menu" href="index.php?controller=cart">Giỏ hàng</a></li>
        <li><a style="color:black;font-weight:bold;font-size:15px" class="bottom-header-menu" href="index.php?controller=news">Tin tức</a></li>
        <li><a style="color:black;font-weight:bold;font-size:15px"   class="bottom-header-menu" href="index.php?controller=contact">Liên hệ</a></li>
      </ul>
