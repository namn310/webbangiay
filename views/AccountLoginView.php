      ...
      <div class="wrapper-form">
        <form method='post' action="index.php?controller=account&action=loginPost">
          ...
          <div class="form-group">
            ...
            <input style="font-size:14px" type="email" class="input-control" name="email" value="user@gmail.com" required="">
          </div>
          <div class="form-group">
            <label>Mật khẩu:<b id="req">*</b></label>
            <input style="font-size:14px" type="password" class="input-control" name="password" value="123456789" required="">
          </div>
