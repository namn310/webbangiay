...
<div class="top">
  <div class="row">
    ...
    <div class="col-xs-12 col-md-6 info">
      ...
      <p itemprop="price" class="price-box product-price-box"> <span class="special-price"> <span style="color:red" class="price product-price"> <?php echo number_format($record->price-($record->price*$record->discount)/100); ?>₫ </span></span></p>
    </p>
    <a href="index.php?controller=cart&action=create&id=<?php echo $record->id; ?>" class="btn btn-danger">Cho vào giỏ hàng</a>
    <!-- rating -->
